        ...
        <?php
          if ((isset($_POST["startDate"])) && (isset($_POST["endDate"])))
          {
            ...
            $decoded = json_decode($data, true);
                ...
                // section to find asteroid data
                        $asteroidCountList = []; //to find the number of asteroids each day
                        $fastestAsteroidsList = []; //to find the number of asteroids each day
                        $closestAsteroidsList = []; //to find the fastest asteroid in km/h
                        $sizeAsteroidsList = []; //to find average size of asteroids
